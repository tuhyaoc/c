...
for(x=0;x<8;x++){
	...
	transitionimages[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/transition/"+x+".webp";
};
...
for(x=0;x<sounds.length;x++){
	...
	sounds[x].file.src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/sounds/"+sounds[x].name;
...
loadroomImages = function(){
	...
	for(x=0;x<roomImagesIndex.length;x++){
		for(y=0;y<roomImagesIndex[x].amountofImages;y++){
			...
			roomImages[x][y].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/"+roomImagesIndex[x].name+"/"+y+".webp"
...
function loadEverythingElse(){
		...
		//if(localStorage["fnaf-js-savegame.night"]!="5" || localStorage["fnaf-js-savegame.night"]!="6" || localStorage["fnaf-js-savegame.night"]!="7"){ 
			document.getElementById("loadingicon").src=("https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/loading/loading"+night+".png");
		//} else {
	...
	for(x=0;x<1;x++){
		...
		officestates[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/"+x+".webp";
	};
	for(x=0;x<rooms.length;x++){
		roomnameimages[x] = new Image();
		roomnameimages[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/camera/roomnames/"+rooms[x].name+".webp";
	};
	for(x=0;x<(3);x++){
		for(y=0;y<2;y++){
			if(!officelightstates[x]) officelightstates[x] = [];
			officelightstates[x][y] = new Image();
			officelightstates[x][y].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/"+x+"_light"+yArray[y]+".webp";
		};
	};
	for(x=1;x<5;x++){
		buttonleftstates[x] = new Image();
		buttonleftstates[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/buttons/buttonleft_"+x+".webp";
	};
	for(x=1;x<5;x++){
		buttonrightstates[x] = new Image();
		buttonrightstates[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/buttons/buttonright_"+x+".webp";
	};
	for(x=0;x<14;x++){
		doorrightanim[x] = new Image();
		doorrightanim[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/doors/right/"+x+".webp";
		doorleftanim[x] = new Image();
		doorleftanim[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/doors/left/"+x+".webp";
	};
	for(x=1;x<6;x++){
		powerusageimage[x] = new Image();
		powerusageimage[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/camera/power"+x+".png";
	};
	for(x=0;x<10;x++){
		powerusagenumbersimage[x] = new Image();
		powerusagenumbersimage[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/camera/ui/powernumbers/"+x+".png";
	};
	for(x=0;x<7;x++){
		timehourimage[x] = new Image();
		timehourimage[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/camera/ui/time"+x+".png";
	};
	for(x=0;x<10;x++){
		camerafeedanimationimage[x] = new Image();
		camerafeedanimationimage[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/camera/camerafeedanimation/"+x+".webp";
	};
	for(x=0;x<2;x++){
		room2aimage[x] = new Image();
		room2aimage[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/2a/"+x+".webp";
	};
	for(x=0;x<31;x++){
		room2afoxxyanim[x] = new Image();
		room2afoxxyanim[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/2a/foxxy/"+x+".webp";
	};
	for(x=1;x<4;x++){
		fananim[0+x] = new Image();
		fananim[0+x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/fan_"+x+".webp";
	};
	for(x=0;x<21;x++){
		foxxyofficeanim[x] = new Image();
		foxxyofficeanim[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/foxxy/"+x+".webp";
	};
	for(x=0;x<2;x++){
		poweroutimg[x] = new Image();
		poweroutimg[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/powerout"+x+".webp";
	};
	for(x=0;x<20;x++){
		freddyanimationgameover[x] = new Image();
		freddyanimationgameover[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/gameover/freddy/"+x+".webp";
	};
	for(x=0;x<31;x++){
		freddyofficeanimationgameover[x] = new Image();
		freddyofficeanimationgameover[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/gameover/freddyoffice/"+x+".webp";
	};
	for(x=0;x<22;x++){
		bonnyanimationgameover[x] = new Image();
		bonnyanimationgameover[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/gameover/bonny/"+x+".webp";
	};
	for(x=0;x<16;x++){
		chicaanimationgameover[x] = new Image();
		chicaanimationgameover[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/gameover/chica/"+x+".webp";
	};
	setTimeout(function(){
...
for(x=0;x<4;x++){
	...
	mainmenufazbear[x].src = "https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/mainmenu/"+x+".webp";
};
