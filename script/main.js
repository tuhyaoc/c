...
function updatePowerPercent() {
	...
	if (currentPower<=0){
    	numberonediv.attr("src","https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/cameraposition.webp");
    	numbertwodiv.attr("src","https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/cameraposition.webp");
    	...
    	numberthreediv.attr("src","https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/rooms/office/cameraposition.webp");
    };
};

function updatePowerUsage() {
	powerusagediv.attr("src","https://cdn.jsdelivr.net/gh/tuhyaoc/c@main/graphics/camera/power"+(currentPowerUsage+1)+".png");
